...
| `pauseWhenHidden`      | `true`     | boolean                            | Pauses cloned video/custom animations while hidden.           |
...
Presets are declarative partial setting snapshots applied with one `setMany()` call:
