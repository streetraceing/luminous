...
- Protected long-form NPV video uses the original Spotify video element directly as the background instead of DRM-incompatible stream capture; the right sidebar keeps its normal scrolling and shows the current artwork in the vacated video area.
